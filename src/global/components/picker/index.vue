/*
 * @Author: Ge.Yuanjun
 * @Date: 2017-08-01 15:24:25
 * @Last Modified by: Ge.Yuanjun
 * @Last Modified time: 2017-08-02 11:44:15
 */

<template>
  <div class="m-picker">
    <m-flexbox direction="vertical" class="align-center">
      <m-flexbox-item v-for="(one, index) in data" :key="index" style="margin-left:0;">
        <div class="alc-picker-item" :id="`alc-picker-${uuid}-${index}`"></div>
      </m-flexbox-item>
    </m-flexbox>
  </div>
</template>
...
<script>
import { Flexbox, FlexboxItem } from 'ui/flexbox'
