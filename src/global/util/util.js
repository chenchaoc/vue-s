 ...
 * @Last Modified by: chenchao
 * @Last Modified time: 2018-09-10 10:54:11
*/
...
const detector = (function detect(ua) {
  ...
  if (/Wyb/i.test(ua)) { //是否app内
    browser.isApp = true
    browser.appVersion = (ua.match(/Wyb_iOS_([\d\.]+)/) || ua.match(/Wyb_Android_([\d\.]+)/))[1]
  }
...
/**
 * [fullTime 获取完整时间 返回例子：2014-06-27 13:57:24]
